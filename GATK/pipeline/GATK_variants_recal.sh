...
#### how to use:
#### example:
#### sh GATK_variants_recal.sh --vcf=input.raw.vcf --ref=ucsc.hg19.fasta --kg=1000G_phase1.indels.hg19.sites.vcf --gold=Mills_and_1000G_gold_standard.indels.hg19.sites.vcf --dbsnp=dbsnp_138.hg19.vcf --hapmap=hapmap_3.3.hg19.sites.vcf --omni=1000G_omni2.5.hg19.sites.vcf --nt=8 --out=output

echo "@-------------------------------------------------------------@"
echo "|     GATK_variants_recal    |     v1.0.0   |   29 Jun 2016   |"
echo "|-------------------------------------------------------------|"
