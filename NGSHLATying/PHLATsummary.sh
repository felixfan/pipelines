...
# check ambigous
awk '$2 ~/,/ {$2="ambigous"} 1' HLAtype.txt > temp.txt
awk '$3 ~/,/ {$3="ambigous"} 1' temp.txt > temp1.txt
awk '$4 ~/,/ {$4="ambigous"} 1' temp1.txt > temp.txt
awk '$5 ~/,/ {$5="ambigous"} 1' temp.txt > temp1.txt
awk '$6 ~/,/ {$6="ambigous"} 1' temp1.txt > temp.txt
awk '$7 ~/,/ {$7="ambigous"} 1' temp.txt > temp1.txt
awk '$8 ~/,/ {$8="ambigous"} 1' temp1.txt > temp.txt
awk '$9 ~/,/ {$9="ambigous"} 1' temp.txt > temp1.txt
awk '$10 ~/,/ {$10="ambigous"} 1' temp1.txt > temp.txt
awk '$11 ~/,/ {$11="ambigous"} 1' temp.txt > temp1.txt
awk '$12 ~/,/ {$12="ambigous"} 1' temp1.txt > temp.txt
awk '$13 ~/,/ {$13="ambigous"} 1' temp.txt > HLAtype.txt
